      ...
      <div className="container py-12 md:py-16">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="mt-12 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            ...
            <div>
              ...
              <ul role="list" className="mt-4 space-y-4">
                <li>
                  <a href="tel:+5511999999999" className="text-base text-gray-500 hover:text-gray-900">
                    (11) 99999-9999
                  </a>
                </li>
                <li>
                  <a href="mailto:contato@mendonca.com" className="text-base text-gray-500 hover:text-gray-900">
                    contato@mendonca.com
                  </a>
                </li>
                <li>
                  <a href="https://wa.me/5511999999999" className="text-base text-gray-500 hover:text-gray-900">
                    WhatsApp
                  </a>
                </li>
              </ul>
        ...
        <div className="mt-12 border-t border-gray-200 pt-8">
          <p className="text-base text-gray-400 xl:text-center">
            &copy; {new Date().getFullYear()} Mendonça Psicoterapia. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
